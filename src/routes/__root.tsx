...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "author", content: "Team Tech Wizards" },
      { property: "og:title", content: "AgriTwin AI — AI-Powered Digital Twin for Precision Agriculture" },
      { property: "og:description", content: "Real-time digital twin platform for precision farming — built by Team Tech Wizards." },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary_large_image" },
      { name: "twitter:title", content: "AgriTwin AI — AI-Powered Digital Twin for Precision Agriculture" },
      { name: "twitter:description", content: "Real-time digital twin platform for precision farming — built by Team Tech Wizards." },
    ],
    links: [
      {
        rel: "stylesheet",
